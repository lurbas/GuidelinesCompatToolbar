 ...
 * using the {@link android.support.v7.app.ActionBarActivity#setSupportActionBar(ResponsiveToolbar)
 ...
 */
public class ResponsiveToolbar extends ViewGroup {
    ...
    public ResponsiveToolbar(Context context) {
        this(context, null);
    }

    public ResponsiveToolbar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.toolbarStyle);
    }

    public ResponsiveToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * ActionBar API. See
     * {@link android.support.v7.app.ActionBarActivity#setSupportActionBar(ResponsiveToolbar)
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (mCollapseButtonView.getParent() != ResponsiveToolbar.this) {
                addView(mCollapseButtonView);
            }
            mExpandedActionView = item.getActionView();
            mCurrentExpandedItem = item;
            if (mExpandedActionView.getParent() != ResponsiveToolbar.this) {
                final LayoutParams lp = generateDefaultLayoutParams();
                lp.gravity = GravityCompat.START | (mButtonGravity & Gravity.VERTICAL_GRAVITY_MASK);
                lp.mViewType = LayoutParams.EXPANDED;
