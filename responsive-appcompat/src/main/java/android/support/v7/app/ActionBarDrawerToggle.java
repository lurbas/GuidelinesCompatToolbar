...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
     ...
     */
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout,
            ResponsiveToolbar toolbar, @StringRes int openDrawerContentDescRes,
            @StringRes int closeDrawerContentDescRes) {
     ...
     * animation.
     */
    <T extends Drawable & DrawerToggle> ActionBarDrawerToggle(Activity activity, ResponsiveToolbar toolbar,
    ...
    static class ToolbarCompatDelegate implements Delegate {
        ...
        final ResponsiveToolbar mToolbar;

        ToolbarCompatDelegate(ResponsiveToolbar toolbar) {
            mToolbar = toolbar;
        }
