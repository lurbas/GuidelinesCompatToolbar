...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    private ResponsiveToolbar mToolbar;
    ...
    public ToolbarWidgetWrapper(ResponsiveToolbar toolbar, boolean style) {
    ...
    public void setEmbeddedTabView(ScrollingTabContainerView tabView) {
        ...
        if (tabView != null && mNavigationMode == ActionBar.NAVIGATION_MODE_TABS) {
            ...
            ResponsiveToolbar.LayoutParams lp = (ResponsiveToolbar.LayoutParams) mTabView.getLayoutParams();
    ...
    private void ensureSpinner() {
        if (mSpinner == null) {
            ...
            ResponsiveToolbar.LayoutParams lp = new ResponsiveToolbar.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
