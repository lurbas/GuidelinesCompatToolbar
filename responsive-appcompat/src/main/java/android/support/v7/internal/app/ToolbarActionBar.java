...
public class ToolbarActionBar extends ActionBar {
    ...
    private final ResponsiveToolbar.OnMenuItemClickListener mMenuClicker =
            new ResponsiveToolbar.OnMenuItemClickListener() {
                @Override
    ...
    public ToolbarActionBar(ResponsiveToolbar toolbar, CharSequence title, Window window,
